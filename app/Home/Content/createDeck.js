...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const user = await initSiteAuth({ loginPath: '../../HTML/Register/Login.html', homePath: '../home.html' });
  initSidebar();

  // 2. Carregar Flashcards para seleção (se logado)
  if (user) {
