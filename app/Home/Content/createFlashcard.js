...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    await initSiteAuth({ loginPath: '../../HTML/Register/Login.html', homePath: '../home.html' });

    // 2. Inicializa a Sidebar (Menu Lateral)
    initSidebar();
...
function initSidebar() {
    ...
    const openBtn = el('sidebarToggle');
    const closeBtn = el('closeSidebar');
