// app/common/auth.js
// Adjust this path to point to your Supabase connection file
...
export async function initSiteAuth({ siteTitleId = 'siteTitle', loginPath = '/thesis/app/HTML/Register/Login.html', homePath = '/thesis/app/Home/home.html' } = {}) {
    const user = await getUser();
